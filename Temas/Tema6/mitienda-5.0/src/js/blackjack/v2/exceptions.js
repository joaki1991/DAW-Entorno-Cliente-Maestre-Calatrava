...
function BlackJackException(message) {
  ...
  const instance = BaseException.call(this, message);
...
function NullCardException() {
  const instance = BlackJackException.call(this, 'Error: Card Argument is null or invalid.');
...
function Upper21Exception() {
  const instance = BlackJackException.call(this, 'The score is upper 21.');
