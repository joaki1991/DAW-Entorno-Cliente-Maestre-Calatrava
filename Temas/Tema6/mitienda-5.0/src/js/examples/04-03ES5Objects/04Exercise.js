(function () {
  ...
  function InvalidAccessConstructorException() {
    const instance = BaseException.call(this, 'Constructor can’t be called as a function.');
  ...
  function EmptyValueException(param) {
    const instance = BaseException.call(this, `Error: The parameter ${param} can't be empty.`);
  ...
  function InvalidValueException(param, value) {
    const instance = BaseException.call(this, `Error: The paramenter ${param} has an invalid value. (${param}: ${value})`);
  ...
  buttons[0].addEventListener('click', () => {
    ...
    const smartphone = new Smartphone('333-333-333', 'Brand', 'Model', 750);
    ...
    const camera = new Camera('444-444-444', 'Canon', 'PowerShot', 285);
    camera.type = 'Digital';
    camera.resolution = 8;
    camera.size = 5;
    ...
    const tablet = new Tablet('555-555-555', 'Samsung', 'Galaxy', 250);
    tablet.memory = '32GB';
    tablet.storage = '1TB';
