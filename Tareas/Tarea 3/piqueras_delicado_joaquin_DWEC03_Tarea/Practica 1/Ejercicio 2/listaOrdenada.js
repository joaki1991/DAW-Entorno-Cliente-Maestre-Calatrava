...
//El ejercicio lo muestra como un entero, pero dado que no se va a operar con el, es mejor mostrarlo como un string
...
function add(list, elem) {    
  ...
  if (validarISBN.test(elem.ISBN) == false) {//Excepción, del ejercicio 4, en caso de que el ISBN no tenga el formato correcto
	...
	if (!isFull(list)) { //Añadimos si la lista no está completa
		...
		list.sort(function(a, b){return a.ISBN.localeCompare(b.ISBN)});     
